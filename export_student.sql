...
Insert into STUDENT (STUDNO,NAME,USERID,GRADE,IDNUM,BIRTHDATE,TEL,HEIGHT,WEIGHT,DEPTNO,PROFNO) values (12346,'김김김',null,null,null,null,null,null,null,null,null);
...
--------------------------------------------------------
  ...
  ALTER TABLE "STUDENT" MODIFY ("NAME" CONSTRAINT "STUD_NAME_NN" NOT NULL ENABLE);
